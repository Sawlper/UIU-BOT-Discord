...
class About(commands.Cog):
    ...
    @app_commands.command(name="about", description="Shows all the important details about this bot.")
    async def about_command(self, interaction: discord.Interaction):
        ...
        embed = discord.Embed(
            ...
            description=f"{BOT_NAME} v{BOT_VERSION}. A bot for notices, updates, and community info.",
            color=0xCCCCCC
        )
        ...
        embed.add_field(name="Owner / Developer", value=f"{BOT_OWNER}", inline=True)
        embed.add_field(name="Contact Email", value="anikhasan2@icloud.com", inline=True)
        embed.add_field(name="Status", value="Under active development. New features coming soon!", inline=False)
